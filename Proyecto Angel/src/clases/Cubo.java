...
public class Cubo extends Herencia{
	...
	public Cubo(int x, int y, int ancho, int alto, String indiceImagen, int velocidad, String animacionActual) {
	...
	public void inicializarAnimaciones() {
			...
			Rectangle coordenadasMover[]= {
					...
					new Rectangle(0, 507, 46, 42),				//CUBO ROJO
					new Rectangle(598, 461, 45, 42),
					new Rectangle(460, 553, 46, 42),
					new Rectangle(92, 462, 45, 42),
					new Rectangle(460, 738, 46, 41)		
